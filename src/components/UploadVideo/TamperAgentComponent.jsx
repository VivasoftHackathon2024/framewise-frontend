...
const TamperAgentComponent = ({ tamperEvaluation }) => {
    const [isExpanded, setIsExpanded] = useState(false);

    const parsedData = tamperEvaluation?.tamper_evaluation ?
        JSON.parse(tamperEvaluation.tamper_evaluation) : null;
    ...
    const lastIndex = parsedData.tamper_incidents.length - 1;
    const lastIncidentSeverity = parsedData.tamper_incidents[lastIndex].severity;
        ...
        <div className="mb-4 rounded-xl shadow-lg overflow-hidden border border-gray-200">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-lg font-bold">Tamper Incident Analysis</h2>
            ...
            {isExpanded && (
                <div className="border-t border-gray-200 p-4">
                    <div className="space-y-4">
                        {parsedData.tamper_incidents.slice(0, lastIndex).map((incident, index) => (
...
export default TamperAgentComponent; 